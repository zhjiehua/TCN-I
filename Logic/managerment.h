...
//定义电机对应功能
#define CLAMP1_MOTOR		DCMOTOR12	//夹紧1
#define CLAMP2_MOTOR		DCMOTOR11	//夹紧2
#define CUTOFF1_MOTOR		DCMOTOR10	//切断1
#define CUTOFF2_MOTOR		DCMOTOR9	//切断2
#define	HEATING_MOTOR		DCMOTOR8	//加热片抬起
#define	SAPERATE_MOTOR		DCMOTOR7	//分离
#define STARTLAMP_MOTOR		DCMOTOR10	//启动开关的灯
#define	DISPOS_MOTOR		0			//错位
#define CUTOFF1HEATDCMOTOR1 DCMOTOR14	//切断1加热片1
#define CUTOFF1HEATDCMOTOR2 DCMOTOR13	//切断1加热片2
#define CUTOFF2HEATDCMOTOR1 DCMOTOR3	//切断2加热片1
#define CUTOFF2HEATDCMOTOR2 DCMOTOR2	//切断2加热片2
#define FUSINGHEATDCMOTOR   DCMOTOR1	//熔接加热片
